    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-blue-50 to-white">
      <div className="max-w-[420px] w-full bg-white/70 backdrop-blur-lg p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-white/40">
        <div className="mb-10 text-center">
          <p className="text-gray-500 text-sm mt-2">Authorization</p>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          {...field}
                          className="h-auto rounded-xl border-gray-100 bg-gray-50/50 px-5 py-4 pr-14 text-sm text-gray-700 shadow-none transition-all focus-visible:ring-2 focus-visible:ring-blue-500/20"
              ...
              <div className="flex justify-end">
                <button
                  type="button"
                  className="text-blue-500 hover:underline text-xs font-medium transition-colors"
            ...
            >
              {isPending ? <Loader2 className="mx-auto animate-spin" size={18} /> : "Log in"}
            </Button>
